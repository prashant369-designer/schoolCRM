...
export default function ProfileSecurityUI() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${base_url}/auth/teachers/changeemail/${id}`,
        data,
      );
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${base_url}/auth/teachers/changepassword/${id}`,
        Passdata,
      );
      console.log(response.data);
      alert(response.data.message);
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${base_url}/auth/teachers/forgotpassword/${id}`,
        forgotData,
      );
      console.log(response.data);
      alert(response.data.message);
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="mb-1 flex items-center gap-2 text-xs font-medium text-indigo-600">
                  <GraduationCap size={16} /> Teacher Profile Portal
                </p>
